...
<template>
    ...
    <section class="bg-white h-screen w-screen">
        <div class="grid grid-cols-1 lg:grid-cols-2 h-full w-full">
            <div
                class="relative flex items-end px-4 pb-10 pt-60 sm:pb-16 md:justify-center lg:pb-24 bg-gray-50 sm:px-6 lg:px-8 h-full w-full lg:block hidden">
