...
<template>
    <div class="flex min-h-screen">
        <aside
            class="relative flex w-full max-w-[20rem] flex-col rounded-xl bg-white bg-clip-border p-4 text-gray-700 shadow-xl shadow-blue-gray-900/5 md:hidden lg:flex">
            <div class="p-4 mb-2">
